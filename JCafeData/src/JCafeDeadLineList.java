...
public class JCafeDeadLineList extends JPanel implements ActionListener, PropertyChangeListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		if (arg0.getSource() == btnSet) {// 완료
			int okCancelChk =JOptionPane.showConfirmDialog(this, "금일 재고 등록을 완료하시겠습니까?", "", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE, null);
